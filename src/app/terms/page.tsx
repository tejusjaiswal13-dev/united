        ...
        <div className="min-h-screen bg-background text-foreground overflow-hidden">
            ...
            <section className="relative pt-32 pb-20 px-4 overflow-hidden">
                ...
                <div className="container mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        {/* CSS-based Rules Grid Visual */}
                        <div className="relative w-full h-full flex items-center justify-center">
                            <div className="absolute inset-0 bg-cosmic-900/10 rounded-3xl border border-white/5" />

                            <div className="grid grid-cols-4 grid-rows-4 gap-4 w-64 h-64 relative">
                                {[...Array(16)].map((_, i) => (
                                    <motion.div
                                        key={i}
                                        initial={{ opacity: 0 }}
                                        ...
                                        className="bg-primary/10 rounded-md border border-primary/20"
                                    />
                                ))}

                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="w-20 h-20 bg-background/80 blur-xl absolute" />
                                    <motion.div
                                        animate={{ scale: [1, 1.1, 1] }}
                                        transition={{ duration: 3, repeat: Infinity }}
                                    >
                                        <Scale className="w-16 h-16 text-primary relative z-10" />
                                    </motion.div>
                                </div>
                            </div>
                        </div>
